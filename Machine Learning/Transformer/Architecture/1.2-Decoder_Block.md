A decoder block is an abstraction of [2.4-Multi_Head_Self_Attention](2.4-Multi_Head_Self_Attention.md)
![](Decoder.png)
...
---
## Example
Using the masked self-attention result from [2.2-Masked_Self_Attention](2.2-Masked_Self_Attention.md) as $Z_{M\text{-}MHSA}$ (single head, H=1) and the encoder output from [1.1-Encoder_Block](1.1-Encoder_Block.md):
$$
...
Assume the same FFN as in [1.1-Encoder_Block](1.1-Encoder_Block.md):
$$
