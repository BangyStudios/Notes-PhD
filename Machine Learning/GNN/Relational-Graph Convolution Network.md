A Relational Graph Convolution Network (R-GCN) is a type of [Graph Neural Network](Graph%20Neural%20Network.md) designed to operate on multi-relational graphs, such as [knowledge graphs](Knowledge%20Graph.md) ([Paper](Schlichtkrull2017RGCN.pdf)).
