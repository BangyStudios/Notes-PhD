...
> > The predominant approach relies on the [autoregressive modeling (ARM)](Autoregression.md)—commonly referred to as the “next-token prediction” paradigm—to define the model distribution:
